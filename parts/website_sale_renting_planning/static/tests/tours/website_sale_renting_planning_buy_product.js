...
registry.category("web_tour.tours").add('website_sale_renting_planning_buy_product', {
    url: '/shop',
    steps: () => [
        {
            content: "Open product page",
            trigger: '.oe_product_image_link[title="Product Renting Planning"]',
            expectUnloadPage: true,
            run: "click",
        },
        {
            content: "Check if the product is Product Renting Planning",
            trigger: 'h1:contains("Product Renting Planning")',
        },
        {
        ...
        },
        {
            ...
            trigger: '.o_date_item_cell',
            run: () => {
                const cells = Array.from(document.querySelectorAll('.o_date_item_cell:not(.o_daterangepicker_danger)'));
        ...
        {
            content: "Click the view cart button",
            trigger: 'a:contains("View Cart")',
            expectUnloadPage: true,
            run: "click",
        },
        {
            content: "Click the pay with demo button",
